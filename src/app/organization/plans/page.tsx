		...
		<section className="section">
			<div className="section-heading">
				<div className="flex justify-between sm:justify-start flex-1 items-center gap-4">
					<h1 className="font-bold text-xl w-max flex sm:text-2xl text-center">
						Annual Plan
					</h1>
				...
				{annualPlan?.request_for_approval_gppa && (
					<div className="flex items-center">
						<RequestAnnualPlanApproval
							annualPlan={annualPlan}
							requestType={"GPPA"}
				...
				{annualPlan?.request_for_approval_both && (
					<div className="flex items-center">
						<RequestAnnualPlanApproval
							annualPlan={annualPlan}
							requestType={"BOTH"}
					...
					<div className="section-heading">
						<div className="grid">
							<h2 className="font-bold text-xl">
								{annualPlan.title}
								{annualPlan.officer && (
									<small className="text-muted-foreground text-sm font-medium pl-6">
										Authorized by{" "}
										<Link
											href={
		...
		<>
			...
			{plan?.items?.map((item, idx) => (
				<tr key={item.id} className="">
					...
					<td className="">D{formatNumberAsCurrency(Number(item.budget))}</td>
