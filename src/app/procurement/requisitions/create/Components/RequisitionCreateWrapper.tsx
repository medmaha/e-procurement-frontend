		...
		<>
			...
			>
				<div className="w-full pt-6">
					<div className="table-wrapper max-h-[38dvh]">
					...
					<div className="py-4 pt-8 flex items-center justify-between border-t gap-6 flex-wrap mx-6">
						<div className="">
							<Button
								type="button"
								title={"Add Item"}
						...
						<div className="flex-1 max-w-[500px] gap-1.5 grid grid-cols-1 font-semibold">
							<Button
								disabled={invalidForm}
								className="disabled:pointer-events-none font-semibold disabled:opacity-0 transition duration-300"
							>
						...
						<div className="flex items-center gap-2 min-w-[100px]">
							{totalSum && (
								<>
									...
									<p className="text-sm">
										D{formatNumberAsCurrency(Number(totalSum))}
									</p>
								</>
							)}
						</div>
				...
				<div className="p-6 grid gap-x-4 gap-y-4 md:grid-cols-[auto,1fr]">
					<div className="">
						...
						<p className="text-xs opacity-70 leading-relaxed max-w-[60ch] md:max-w-[50ch]">
							...
							start of procurement, outlining needs, and beginning purchase
							approvals.
						</p>
					</div>
						...
						<div className="grid gap-2">
							...
							<div className="h-full">
								<div className="grid gap-1">
									...
									<p className="p-2 border rounded-md min-w-[220px]">
										Managing Director
									</p>
								</div>
							</div>
