...
import ConfirmRejection from "./RejectQuotation";
import RFQResponseBrochures from "./RFQResponseBrochures";
import {
	Select,
	SelectContent,
	SelectGroup,
...
export default function CreateRFQResponse(props: Props) {
	...
	return (
		<Dialog open={isOpen} onOpenChange={setOpen}>
			...
			<DialogContent className="max-w-[1300px] w-full max-h-[98dvh] overflow-hidden overflow-y-auto border-4 shadow-xl">
				<DialogHeader>
					<DialogTitle>
						Response to RFQ |{" "}
			...
			<div className="grid grid-cols-2 lg:grid-cols-[65%,auto] gap-4 pt-4">
				<div className="space-y-2 sm:space-y-4">
					<div className="grid sm:grid-cols-2 sm:gap-2 gap-4 md:gap-4">
						...
						<div className="">
							<Label
								className="pb-1 inline-flex items-center gap-4 font-semibold"
								htmlFor="proforma"
							>
								<span>
									Proforma
						...
						<div className="">
							<Label
								className="pb-1 gap-4 inline-flex items-center font-semibold"
								htmlFor="form101"
							>
								<span>Form-101</span>
							</Label>
					...
					<div className="">
						<Label className="pb-1 font-semibold" htmlFor="remarks">
				...
				<div className="space-y-2">
					{/* <div className="">
						<Label className="pb-1 font-semibold">Authorized By</Label>
					...
					<div>
						<Label className="pb-1 font-semibold">Brochures</Label>
						<RFQResponseBrochures />
					</div>
					<div className="py-4">
						<Label className="text-xs font-semibold pb-2 text-muted-foreground">
							Timestamp
						</Label>
						<p className="p-2 text-muted-foreground rounded-md border">
							<TodaysDate />
						</p>
					</div>
				</div>
