...
export default function AddOrEditGroup({ text, children, group, user }: Props) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-[1100px] min-h-[70dvh] mx-auto">
        <DialogHeader>
        ...
        {isOpen && (
          <div className="dark:p-4 h-full dark:rounded-md">
...
function SubmitButton({ text }: any) {
  ...
  return (
    <Button
      disabled={pending}
      type="submit"
      className="md:font-semibold disabled:pointer-events-none disabled:opacity-70 w-full"
    >
